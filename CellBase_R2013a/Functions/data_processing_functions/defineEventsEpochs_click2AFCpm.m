function [events,epochs] = defineEventsEpochs_click2AFCpm
...
events(i,:) = {'ResponseStart',    'ResponseStart',      'ResponseStart',      [-6 6]};    i = i + 1;
events(i,:) = {'ResponseEnd',      'ResponseEnd',        'ResponseEnd',          [-6 6]};    i = i + 1;
...
events(i,:) = {'WaitingTime',                 'ResponseStart',        'ResponseEnd',     [-6 6]};    i = i + 1;
...
i = 1;
epochs(i,:) = {'StimulusOnset',    'StimulusOnset',       [0.0 0.1],     'StimulusSamplingDuration'};    i = i + 1;
epochs(i,:) = {'WaitingTime',    'ResponseStart',       [0.0 0.1],       'WaitingTime'};    i = i + 1;
epochs(i,:) = {'MovementTime',    'StimulusOffset',       [0.0 0.1],     'MovementTime'};    i = i + 1;