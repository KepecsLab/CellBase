function MakeTrialEvents2_clickAFCBis(sessionpath)
...
[NlxEvents] = GetTrialStartTimeStampPM(EventTTL_task, EventTimestamps);

% Set TTl alignement state at 3 Waitingfor initial poke) Index 5 is DeliverStimulus1
...
ts = TE2.Stimulus1AvailableTimestamp;   % Trial start in absolut time recorded by the behavior control system
...
sto = TE2.Stimulus1OnsetTimestamp;
