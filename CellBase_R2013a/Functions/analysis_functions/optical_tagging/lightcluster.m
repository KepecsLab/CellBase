...
all_spikes = loadingEngine(Nttfn); % FS MOD new convention is for spikes to be loaded in units of seconds
spk = loadcb(cellid,'Spikes');
spk = spk*getcbpref('Spikes_timefactor'); %TT mat file use conversion factor
