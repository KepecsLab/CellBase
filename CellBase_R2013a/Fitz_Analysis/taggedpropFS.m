function error_list = taggedpropFS(I,issave)
...
HM = plot_mclust_projections2(cellid,'feature_names',{'Peak'},...
...
HR = plot_raster_psth(cellid,'PulseOn',false,'PulseOn',true,'PulseFig',NaN,'PulseAx',NaN); % FS MOD kludge
