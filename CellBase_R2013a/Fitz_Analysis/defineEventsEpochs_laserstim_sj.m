function [events,epochs] = defineEventsEpochs_laserstim_sj
...
i = 1;
events(i,:) = {'Pulse',       'Pulse',      'Pulse',      [-0.2 0.2]};   i = i + 1;  % 10Hz stimulation
events(i,:) = {'PulseOn',       'PulseOn',      'PulseOn',      [-0.2 0.2]};   i = i + 1;  % 10Hz stimulation
...
events(i,:) = {'Burst_BL',      'BurstOn',      'BurstOn',      [-0.2 0]}; i = i + 1;
...
i = 1;
epochs(i,:) = {'PulseEpoch',       'PulseOn',      [-0.2 0.2],  'NaN'};   i = i + 1;
